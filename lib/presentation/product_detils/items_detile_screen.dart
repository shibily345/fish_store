...
class _ItemsDetailPageState extends State<ItemsDetailPage> {
  ...
  Widget build(BuildContext context) {
    var product = Get.find<ItemsInfoController>().itemsInfoList[widget.pageId];
    Get.find<ItemsInfoController>().initNew(
    ...
    return Stack(
      children: [
        ...
        GetBuilder<ItemsInfoController>(builder: (productInfo) {
          double totel =
