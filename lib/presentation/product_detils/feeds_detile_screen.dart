...
class FeedsDetailPage extends StatefulWidget {
  ...
  @override
  State<FeedsDetailPage> createState() => _FeedsDetailPageState();
}

class _FeedsDetailPageState extends State<FeedsDetailPage> {
  @override
  void initState() {
    init();
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        GetBuilder<FeedsInfoController>(builder: (productInfo) {
          double totel =
