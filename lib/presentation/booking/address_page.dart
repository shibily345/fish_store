...
import 'package:betta_store/presentation/booking/confirm_book.dart';
...
import '../../infrastructure/controller/auth_controller.dart';
...
class _AddressPageState extends State<AddressPage> {
    ...
    if (name.isEmpty) {
      ...
      Get.find<AddressInfoController>()
        ...
        if (response.isSuccess) {
          ...
          Get.snackbar("pattola bro Address", "seriikk adikk Success");
        }
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    Get.find<AddressInfoController>().getAddressList();
    return Scaffold(body: GetBuilder<AddressInfoController>(
      builder: (addressController) {
        // if (Get.find<AddressInfoController>().getAddress != "") {
        //   _nameController.text = addressController.getAddress.name;
        // }
