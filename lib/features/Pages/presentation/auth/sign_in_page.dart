...
import 'package:betta_store/features/Pages/presentation/auth/widgets/sign_in_fields.dart';
import 'package:betta_store/features/Pages/presentation/auth/widgets/top_contents.dart';
        ...
        auth.login(phone, password).then((status) {
          if (status.isSuccess) {
            ...
            showCustumeSnackBar(
                ...
                "Incorrect passwoerd or phone number");
          } else {
