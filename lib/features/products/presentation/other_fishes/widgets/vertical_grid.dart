...
class OtherFishesGrid extends StatefulWidget {
  const OtherFishesGrid({super.key});

  @override
  State<OtherFishesGrid> createState() => _OtherFishesGridState();
}

enum SortOption { newest, priceHighToLow, priceLowToHigh, oldest }

class _OtherFishesGridState extends State<OtherFishesGrid> {
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ProductTileGrid(
                      productInfoList: otherFishes, index: index);
                },
              ),
            ),
